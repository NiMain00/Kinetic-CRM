    ...
    const [data, total] = await Promise.all([
      this.prisma.project.findMany({
        ...
        select: {
          ...
          type: true, description: true, estimatedValue: true,
          createdAt: true, updatedAt: true, ownerUserId: true,
          sourceProspectId: true, isConverted: true, branch: true,
          category: { select: { id: true, name: true, color_hex: true } },
          statusDef: { select: { id: true, label: true, color_hex: true, text_color_hex: true } },
