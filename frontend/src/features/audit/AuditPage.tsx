...
const INITIAL_LOGS: AuditLogEntry[] = [
  ...
  { id: 'AUD-005', timestamp: '2026-06-21 14:10:55', actor: 'Siti Aminah', actorInitials: 'SA', action: 'REJECT', entityType: 'Prospek', entityId: 'PR-2023-08-015', entityName: 'IoT Sensor Network', summary: 'Menolak prospek karena spesifikasi teknis tidak sesuai', before: '{"status":"Waiting Supervisor"}', after: '{"status":"Revision","reason":"Spesifikasi teknis tidak sesuai standar"}', ipAddress: '192.168.1.115', impact: 'Medium' },
