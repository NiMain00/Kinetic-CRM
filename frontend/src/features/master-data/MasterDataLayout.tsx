...
export default function MasterDataLayout() {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-background overflow-hidden text-on-surface">
      <div className="bg-surface-container-lowest border-b border-border px-8 py-4 shrink-0 shadow-sm z-10">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[11px] text-outline mt-0.5">Pengelolaan data referensi terpusat untuk seluruh sistem.</p>
          </div>
        </div>
      </div>

      <div className="bg-surface-container-lowest border-b border-border shrink-0">
