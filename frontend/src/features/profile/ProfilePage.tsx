      ...
      <div className="bg-white border-b border-border px-8 py-4 shrink-0 flex flex-col sm:flex-row justify-between sm:items-center gap-4 shadow-sm z-10">
        <div>
          <nav className="flex items-center gap-2 mb-1.5 font-caption-xs text-caption-xs text-secondary">
            ...
            <span className="text-primary font-bold uppercase tracking-wider">Account Portal</span>
          </nav>
          <h2 className="font-display-title text-base font-extrabold text-slate-900">
            User Profile
          </h2>
          <p className="text-[11px] text-slate-400 mt-0.5 font-sans">Manage your personal information, security credentials, and system settings.</p>
        </div>
      </div>
              ...
              <form onSubmit={handleSaveProfile} className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-8 border-b border-slate-100 pb-6">
                  ...
                  <div className="flex flex-col items-center gap-2 group shrink-0">
                    ...
                    <p className="text-[10px] text-slate-400">JPG or PNG, max size 2MB</p>
                  </div>
                  ...
                  <div className="flex-grow w-full space-y-4">
                    ...
                    <div className="p-4 bg-slate-50/50 rounded-xl border border-border border-l-4 border-primary space-y-2 text-[11px]">
                      <p className="text-[9px] font-bold text-slate-450 uppercase tracking-widest leading-none">Security Permissions context</p>
                      <p className="text-slate-600 font-medium">{fullName} is authorized to sign off budgets under regular operations. Key actions are logged securely under credentials session footprint.</p>
                    </div>
                ...
                <div className="space-y-4">
                  <h4 className="text-xs font-bold text-slate-700 uppercase tracking-wider">Enterprise Credentials Context</h4>
                  
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    
                    <div className="space-y-1 bg-slate-50 p-3 rounded-lg border border-border">
                      <label className="text-[10px] font-bold text-slate-450 uppercase tracking-wider block mb-1">Username (Immutable)</label>
                    ...
                    <div className="space-y-1 bg-slate-50 p-3 rounded-lg border border-border">
                      <label className="text-[10px] font-bold text-slate-450 uppercase tracking-wider block mb-1">Assigned Role</label>
                    ...
                    <div className="sm:col-span-2 space-y-1 bg-slate-50 p-3 rounded-lg border border-border">
                      <label className="text-[10px] font-bold text-slate-450 uppercase tracking-wider block mb-1">Home Department Office branch</label>
                      <div className="flex items-center justify-between font-medium text-[11px] text-slate-600">
            ...
            <div className="md:col-span-4 space-y-6">
              ...
              <div className="bg-white border border-border rounded-xl p-5 shadow-xs">
                ...
                <p className="text-[11px] text-slate-500 mb-4 leading-relaxed">
                  Update your organizational password to remain fully compliant with active security guidelines.
                </p>
                ...
                <div className="mt-4 p-3 bg-amber-50/50 border border-amber-300/30 rounded-lg flex gap-2.5">
                  ...
                  <p className="text-[10px] text-amber-700 leading-normal">
                    Password update: <strong>42 days ago</strong>. Corporate operations require a rotation every 90 days.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white border border-border rounded-xl p-5 shadow-xs">
                ...
                <div className="space-y-3.5 text-xs text-slate-650">
                  <div className="flex justify-between items-center py-1.5 border-b border-slate-100">
                    <span className="text-slate-400 font-semibold text-[11px]">Last Login</span>
                    <span className="font-mono text-[11px] text-slate-700 font-bold">2026-06-21 08:42:11</span>
                  </div>

                  <div className="flex justify-between items-center py-1.5 border-b border-slate-100">
                    <span className="text-slate-400 font-semibold text-[11px]">Secure IP</span>
                    <span className="font-mono text-[11px] text-slate-700">192.168.1.142</span>
                  </div>

                  <div className="flex justify-between items-center py-1.5 border-b border-slate-100">
                    <span className="text-slate-400 font-semibold text-[11px]">Resolved Location</span>
          ...
          <div className="bg-slate-50 border border-border rounded-xl p-5 sm:p-6 shadow-xs">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-bold text-slate-800 text-xs">Regional &amp; Language Preferences</h4>
                  <p className="text-[10px] text-slate-400">Set standard locale language, visual timezone, currency scale metrics.</p>
                </div>
              </div>
        ...
        <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-xs z-50 flex items-center justify-center p-4">
          <div className="bg-white border border-border rounded-2xl max-w-sm w-full p-6 shadow-2xl space-y-4">
            ...
            <form onSubmit={handleUpdatePassword} className="space-y-4 text-xs">
              <div className="space-y-1">
                <label className="text-slate-500 font-semibold uppercase text-[10px] tracking-wider block">New Password</label>
                <input
                  type="password"
                  value={newPassword}
              ...
              <div className="space-y-1">
                <label className="text-slate-500 font-semibold uppercase text-[10px] tracking-wider block">Confirm Password</label>
                <input
                  type="password"
