    ...
    <div className="flex-1 flex flex-col h-full bg-background overflow-hidden text-on-surface">
      ...
      <div className="bg-surface-container-lowest border-b border-border px-8 py-4 shrink-0 flex flex-col sm:flex-row justify-between sm:items-center gap-4 shadow-sm z-10">
        <div>
          ...
          <p className="text-[11px] text-outline mt-0.5 font-sans">Kelola informasi pribadi, kredensial keamanan, dan pengaturan sistem Anda.</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-8 bg-surface-container-lowest border border-border rounded-xl shadow-xs p-6 sm:p-8">
              ...
              <form onSubmit={handleSaveProfile} className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-8 border-b border-border pb-6">
                  ...
                  <div className="flex flex-col items-center gap-2 group shrink-0">
                    <div className="relative">
                      <img
                        className="w-24 h-24 sm:w-28 sm:h-28 rounded-full border-4 border-border shadow-md object-cover"
                        alt="Foto profil"
                    ...
                    <p className="text-[10px] text-outline">JPG atau PNG, ukuran maks 2MB</p>
                  </div>
                  ...
                  <div className="flex-grow w-full space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full bg-surface-container-low border border-border rounded-lg px-3 py-2 text-xs font-semibold focus:outline-none focus:ring-1 focus:ring-primary focus:bg-surface-container-lowest"
                        />
                      </div>
                    ...
                    <div className="p-4 bg-surface-container-low/50 rounded-xl border border-border border-l-4 border-primary space-y-2 text-[11px]">
                      <p className="text-[9px] font-bold text-secondary uppercase tracking-widest leading-none">Konteks Izin Keamanan</p>
                      <p className="text-secondary font-medium">{fullName} berwenang menandatangani anggaran dalam operasi reguler. Tindakan penting dicatat dengan aman dalam jejak sesi kredensial.</p>
                    </div>
                ...
                <div className="space-y-4">
                  <h4 className="text-xs font-bold text-secondary uppercase tracking-wider">Konteks Kredensial Perusahaan</h4>
                  
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    
                    <div className="space-y-1 bg-surface-container-low p-3 rounded-lg border border-border">
                      <label className="text-[10px] font-bold text-secondary uppercase tracking-wider block mb-1">Nama Pengguna (Tidak Dapat Diubah)</label>
                    ...
                    <div className="sm:col-span-2 space-y-1 bg-surface-container-low p-3 rounded-lg border border-border">
                      <label className="text-[10px] font-bold text-secondary uppercase tracking-wider block mb-1">Kantor Cabang Departemen</label>
                      <div className="flex items-center justify-between font-medium text-[11px] text-secondary">
            ...
            <div className="md:col-span-4 space-y-6">
              ...
              <div className="bg-surface-container-lowest border border-border rounded-xl p-5 shadow-xs">
                ...
                <p className="text-[11px] text-outline mb-4 leading-relaxed">
              ...
              <div className="bg-surface-container-lowest border border-border rounded-xl p-5 shadow-xs">
                ...
                <div className="space-y-3.5 text-xs text-secondary">
                  <div className="flex justify-between items-center py-1.5 border-b border-border">
                    <span className="text-outline font-semibold text-[11px]">Login Terakhir</span>
                    <span className="font-mono text-[11px] text-secondary font-bold">2026-06-21 08:42:11</span>
                  </div>

                  <div className="flex justify-between items-center py-1.5 border-b border-border">
                    <span className="text-outline font-semibold text-[11px]">IP Aman</span>
                    <span className="font-mono text-[11px] text-secondary">192.168.1.142</span>
                  </div>

                  <div className="flex justify-between items-center py-1.5 border-b border-border">
                    <span className="text-outline font-semibold text-[11px]">Lokasi Terdeteksi</span>
                    <span className="text-secondary font-medium">Chicago, IL (Corporate HQ)</span>
                  </div>
          ...
          <div className="bg-surface-container-low border border-border rounded-xl p-5 sm:p-6 shadow-xs">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-bold text-on-surface text-xs">Preferensi Regional &amp; Bahasa</h4>
                  <p className="text-[10px] text-outline">Atur bahasa lokal standar, zona waktu tampilan, metrik skala mata uang.</p>
                </div>
              </div>
      ...
      {isPasswordModalOpen && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-xs z-50 flex items-center justify-center p-4">
          <div className="bg-surface-container-lowest border border-border rounded-2xl max-w-sm w-full p-6 shadow-2xl space-y-4">
            <div className="flex justify-between items-center pb-2 border-b border-border">
              ...
              <button
                ...
                className="text-outline hover:bg-surface-container-high rounded-full w-8 h-8 flex items-center justify-center transition-colors cursor-pointer"
              >
            ...
            <form onSubmit={handleUpdatePassword} className="space-y-4 text-xs">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-surface-container-low border border-border rounded-lg px-3 py-2 text-xs font-semibold focus:outline-none"
