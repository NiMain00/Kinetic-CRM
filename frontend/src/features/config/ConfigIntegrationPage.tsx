...
function AppsScriptSnippet() {
  ...
  const lines = [
    ...
    '  const answers = {};',
    "  const keyMap = { 'Nama Customer': 'nama_customer', 'Nama PIC': 'pic_name', 'Jabatan PIC': 'pic_position', 'No HP PIC': 'pic_phone', 'Email PIC': 'pic_email', 'Kota': 'kota', 'Industri': 'industri', 'Kebutuhan': 'kebutuhan', 'Level': 'level' };",
    '',
    ...
    '      form_id: e.response.getSource().getId(),',
    '      answers',
    '    })',
    '  });',
    '}',
