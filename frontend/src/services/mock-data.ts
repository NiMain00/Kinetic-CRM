...
export const INITIAL_CUSTOMERS: Customer[] = [
  ...
  export const INITIAL_PROSPECTS: Prospect[] = [
    { id: '1', name: 'Modernization of Data Center Jakarta', client: 'PT. Telekom Nusantara', customerId: 'C002', customerType: 'existing', status: 'Potensial', prospectType: 'potensial', potensiUnit: 3, author: 'Ahmad Sulistyo', date: 'Oct 24, 2023', estimatedValue: 1250000000, description: 'Pengadaan infrastruktur server modular untuk perluasan kapasitas regional base DC Jakarta.', branch: 'Jakarta Pusat', createdByUserId: '1', departmentId: 'dept-marketing', currentStageId: 'stage-prospecting', ownerUserId: '1' },
    { id: '2', name: 'Supply of Industrial High-Voltage Cables', client: 'Energi Bangsa Corp', customerId: 'C003', customerType: 'existing', status: 'Approved', potensiUnit: 5, author: 'Siti Rahmawati', date: 'Oct 22, 2023', estimatedValue: 3400000000, description: 'Pengadaan kabel transmisi tegangan tinggi untuk gardu induk Sumatera Selatan.', branch: 'Cabang Bandung', createdByUserId: '5', departmentId: 'dept-marketing', currentStageId: 'stage-prospecting', ownerUserId: '5' },
    { id: '3', name: 'Surveillance System Implementation Phase 2', client: 'Secure City Group', customerId: 'C004', customerType: 'existing', status: 'Waiting Supervisor', potensiUnit: 2, author: 'Bambang Permadi', date: 'Oct 21, 2023', estimatedValue: 850000000, description: 'Instalasi pemantauan cerdas dengan IP camera berbasis AI di area komersial.', branch: 'Project Management', createdByUserId: '2', departmentId: 'dept-pm', currentStageId: 'stage-supervisor-review', ownerUserId: '2' },
    { id: '4', name: 'Cloud Infrastructure Migration Strategy', client: 'Bank Artha Graha', customerId: 'C005', customerType: 'existing', status: 'Revision', potensiUnit: 1, author: 'Rina Marlina', date: 'Oct 19, 2023', estimatedValue: 1800000000, description: 'Consulting dan restrukturisasi database on-premise ke multi-cloud architecture.', branch: 'Operations Dept', createdByUserId: '3', departmentId: 'dept-procurement', currentStageId: 'stage-prospecting', ownerUserId: '3' },
    { id: '5', name: 'Solar Panel Installation - North Branch', client: 'Lestari Eco Farms', customerType: 'new', status: 'Non Potensial', prospectType: 'non_potensial', potensiUnit: 0, author: 'Ahmad Sulistyo', date: 'Oct 18, 2023', estimatedValue: 950000000, branch: 'Jakarta Pusat', customerData: { id: 'new-1', name: 'Lestari Eco Farms', code: 'LEF', type: 'swasta', city: 'Bandung', picName: 'Dewi Lestari', picPosition: 'Owner', picPhone: '0821-1234-5678', isNew: true, needsVerification: true }, createdByUserId: '1', departmentId: 'dept-marketing', currentStageId: 'stage-prospecting', ownerUserId: '1' },
    { id: '6', name: 'Enterprise Firewall Upgrade - Global', client: 'Defense Tech Solutions', status: 'Approved', potensiUnit: 4, author: 'Bambang Permadi', date: 'Oct 15, 2023', estimatedValue: 600000000, branch: 'Project Management', createdByUserId: '2', departmentId: 'dept-pm', currentStageId: 'stage-in-project', ownerUserId: '2' },
    { id: '7', name: 'Network Optimization Project v3.0', client: 'Global Logistics Inc.', status: 'Waiting Supervisor', potensiUnit: 2, author: 'Rina Marlina', date: 'Oct 14, 2023', estimatedValue: 1100000000, branch: 'Operations Dept', createdByUserId: '3', departmentId: 'dept-procurement', currentStageId: 'stage-supervisor-review', ownerUserId: '3' },
    { id: '8', name: 'Warehouse Automation Consultation', client: 'Express Delivery Hub', status: 'Non Potensial', prospectType: 'non_potensial', potensiUnit: 0, author: 'Siti Rahmawati', date: 'Oct 12, 2023', estimatedValue: 500000000, branch: 'Cabang Bandung', createdByUserId: '5', departmentId: 'dept-marketing', currentStageId: 'stage-prospecting', ownerUserId: '5' },
  ];
...
export const INITIAL_PROJECTS: Project[] = [
  {
    ...
    scopeDepartments: ['dept-it', 'dept-finance', 'dept-procurement'],
    pricing: {
      value: 4250000000,
      margin: 18.4,
  ...
  },
  {
    ...
    currentStageId: 'stage-in-project',
    scopeDepartments: ['dept-it', 'dept-finance'],
    pricing: {
      value: 1250000000,
      margin: 12.5,
  ...
  },
  {
    ...
    currentStageId: 'stage-delivery',
    scopeDepartments: ['dept-pm', 'dept-procurement'],
    pricing: {
      value: 142500000000,
      margin: 15.2,
    ...
    timeline: [
      ...
      { id: 'evt-16', title: 'Proyek Selesai', actor: 'John Doe', role: 'Project Manager', time: 'Feb 1, 2024', type: 'status_change', prevVal: 'Pemenang', newVal: 'Selesai' },
