...
export const INITIAL_CUSTOMERS: Customer[] = [
  ...
  export const INITIAL_PROSPECTS: Prospect[] = [
    ...
    { id: '7', name: 'Network Optimization Project v3.0', client: 'Global Logistics Inc.', status: 'Waiting PM', potensiUnit: 2, author: 'Rina Marlina', date: 'Oct 14, 2023', estimatedValue: 1100000000, branch: 'Operations Dept', createdByUserId: '3', departmentId: 'dept-procurement', currentStageId: 'stage-supervisor-review', ownerUserId: '3' },
