...
export const navItems: NavItem[] = [
  ...
  { label: 'Approval', path: '/approvals', icon: 'approval', roles: ['Super Admin', 'Admin', 'PM', 'Branch Manager', 'Dept Head', 'Management', 'Reviewer'], permissions: ['approval_view'] },
...
export const configNavItems: NavItem[] = [
  ...
  { label: 'Role', path: '/config/roles', icon: 'badge', permissions: ['config_access'] },
  { label: 'Target', path: '/config/targets', icon: 'track_changes', permissions: ['config_access'] },
  { label: 'Workflow', path: '/config/workflow', icon: 'alt_route', permissions: ['config_access'] },
