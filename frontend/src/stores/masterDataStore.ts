...
const INITIAL_QUESTIONS: MasterQuestion[] = [
  ...
  { id: 'Q-003', question_text: 'Jelaskan detail spesifikasi, jumlah, dan kebutuhan khusus untuk pengadaan unit', question_type_id: 'QT-02', context: 'prospect', category: 'Pengadaan Unit', is_required: true, sort_order: 3, placeholder_text: '', help_text: 'Sertakan merek/teknologi yang diutamakan jika ada', is_active: true },
